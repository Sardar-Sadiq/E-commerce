...
in frontend folder
    components- reusable compo
    context- logic of e commerce website
    pages- pages of e commerce


//3:26:17 time stop we are working product display page in that working on add to cart page and its logic
