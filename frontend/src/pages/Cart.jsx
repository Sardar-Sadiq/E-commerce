...
const Cart = () => {
  ...
  const { products, cartItems, currency, updataQuantity } = useContext(ShopContext);
                ...
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-5 mt-2'>
                      ...
                      <p className='px-2 border border-gray-200 sm:px-3 sm:py-1 bg-slate-50'>{item.size}</p>
        ...
        <div className='flex justify-end my-20'>
          <div className='w-full sm:w-112.5'>
            ...
            <div className='w-full text-end'>
              <button className='px-8 py-3 my-8 text-sm text-white bg-black'>PROCEED TO CHECKOUT</button>
            </div>
          </div>
