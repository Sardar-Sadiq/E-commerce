...
const SearchBar = () => {
    ...
    {/*the next block of code is for making the logic which the search bar should be work at only collection page  if the user changes the page it need to be redone*/}
